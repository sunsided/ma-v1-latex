...
\cite{orb} beschreibt einen neuen binären Deskriptor genannt \acro{ORB}, der auf \acro{BRIEF} basiert, jedoch um Rotationsinvarianz und Rauschresistenz erweitert wurde. \acro{ORB} ist (bei vergleichbarer Performance) um zwei Magnituden schneller als \acro{SIFT}.
