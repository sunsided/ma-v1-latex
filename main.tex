...
Das in \cref{fig:vorverBild} gezeigte Quellbild weist eine Dimension von $\SI{1200}{\px} \times \SI{1450}{\px}$ auf, von denen das eigentliche Produktbild jedoch nur ca. $\SI{1009}{\px} \times \SI{514}{\px}$ in Anspruch nimmt.

Würde dieses Bild nun zur Reduktion von Speichergröße und weiteren Verarbeitungszeiten auf eine maximale Kantenlänge von \SI{512}{\px} heruntergerechnet werden --- dies entspräche $\SI{424}{\px} \times \SI{512}{\px}$ --- so würde das eigentliche Produktbild im resultierenden Format nur noch $\SI{357}{\px} \times \SI{181}{\px}$ beanspruchen.

Durch ein zuvoriges Beschneiden des Bildes auf den relevanten Bildbereich -- eine Definition des Begriffes "`relevant"' steht hierbei noch aus -- ergäbe sich indes ein Bereich von $\SI{512}{\px} \times \SI{261}{\px}$ für bildwichtige Inhalte.
