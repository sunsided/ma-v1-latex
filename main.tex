...
wodurch für höhere $k$ entsprechend größere Filter benötigt werden.
...
\end{align}
%
durchgeführt werden kann (\cite{vlfeat:online:2016}, vgl. \cref{eq:sift_deconv}), wodurch die Filtergröße -- mit ihr der benötigte Rechenaufwand -- zusätzlich reduziert wird.
