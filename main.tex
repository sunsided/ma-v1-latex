...
\cite[176]{sonka2008image} erklären Werte in Entfernung von $3\sigma$ vom Mittelpunkt des Gauss-Kernels als zu vernachlässigen ($\mu \pm 3\sigma \approx \SI{99.7}{\percent}$ der Werte der Standardnormalverteilung)
