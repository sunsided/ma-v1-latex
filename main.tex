...
Dieser ist aufgrund seiner Isotropie (Richtungsinvarianz) einer gerichteter Ableitung, 
...
\subsection{Berechnung des Skalenraumes}
\label{subsec:scale_space_sift}

\todo[inline]{\cref{fig:sift_scales} referenzieren}

Um den Skalenraum für die Merkmalsextraktion zu generieren, wird das Eingangsbild mit unterschiedlichen $\sigma$ geglättet.
...
wählt etwa \cite{Nguyen:2007:GG:1407436} folglich einen Filterradius ("`support"') von $\floor*{3\sigma}$ je Dimension.
